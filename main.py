                ...
                if len(data)>=1:
                    for i in data:
                        ...
                        if len(i["pines"]) == 1:
                            ...
                            # print(i["fecha"])
                            # print(i["pines"][0])
                            print("|{:<3} | {:<20} | {:<25} | {:<7}{:<4} | {:<10} | {:<10} | {:<5}|".format(z, i["nombre"],i["valores"],i["fecha"],i["hora"],i["pines"][0]))
                        elif len(i["pines"]) == 2:
                            print("|{:<3} | {:<20} | {:<25} | {:<7}{:<4} | {:<10} | {:<2} {:<2}|".format(z,i["nombre"],i["valores"],i["fecha"],i["hora"],i["pines"][0],i["pines"][1]))
